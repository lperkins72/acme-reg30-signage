...
This folder is the region-default content layer for `reg30`.
...
- `regions/reg30/data/primary-assets.json`
- `regions/reg30/data/primary.json`
- `regions/reg30/data/footer.json`
- `regions/reg30/data/primaryending.json`
- `regions/reg30/assets/primary/manifest.json`
- `regions/reg30/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg30`.
